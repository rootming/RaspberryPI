...
//  #endif
//  Wire.endTransmission();
//  Wire.requestFrom((uint8_t)fd, (int8_t)1);
//  #if ARDUINO >= 100
//    *value = Wire.read();
//  #else
//    *value = Wire.receive();
...
//  #endif
//  Wire.endTransmission();
//  Wire.requestFrom((uint8_t)fd, (int8_t)2);
//  #if ARDUINO >= 100
...
BMP085::BMP085(bmp085_mode_t mode)
{
  // Enable I2C
  if((fd = wiringPiI2CSetup(BMP085_ADDRESS)) == -1){
